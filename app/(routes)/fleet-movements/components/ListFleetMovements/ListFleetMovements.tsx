...
export async function ListFleetMovements() {
  const movements = (
    ...
    destination:
      movement.oper_vuelos.oper_ruta
        ?.genr_aeropuertos_oper_ruta_opru_gear_aerop_destinoTogenr_aeropuertos
        ?.gear_co_iata_aeropuerto || "",
    fob: movement.fob ? formatDecimalValue(movement.fob) : null,
    fod: movement.fod ? formatDecimalValue(movement.fod) : null,
    ...
    fuel_consumed: movement.fuel_consumed
      ...
      : null,
    tow: movement.tow ? formatDecimalValue(movement.tow) : null,
